...
urlpatterns = [
    ...
    path('update-status/<int:request_id>/', views.UpdateDeliveryStatus.as_view(), name='update_status'),
    path('map/', views.DeliveryMapView.as_view(), name='delivery_map'),
    path('start-delivery/<int:request_id>/', views.StartDelivery.as_view(), name='start_delivery'),
    path('complete-delivery/<int:request_id>/', views.CompleteDelivery.as_view(), name='complete_delivery'),
]